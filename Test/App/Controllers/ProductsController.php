<?php
    ...
    /**
     * ProductsController - The ProductsController. This Controller makes use of a few Models for creating, updating, fetching and deleting Products.
     *
        ...
        */
        public function createProduct($request, $response)
        {
            ...
            if (!move_uploaded_file($request->files()->banner['tmp_name'], $bannerPath . $bannerName)) {
                ...
                $Response['status'] = 400;
                $Response['data'] = [];
                $Response['message'] = 'An unexpected error occurred and your file could not be uploaded. Please, try again later.';
         ...
         * Updates a Product.
         *
         * @param mixed $request $response Contains the Request and Response Object from the router.
         * @return mixed Anonymous
        */
        public function updateProduct($request, $response)
        {
            ...
            if (!empty($request->files()->banner)) {                            
                ...
                if (!move_uploaded_file($request->files()->banner['tmp_name'], $bannerPath . $bannerName)) {
                    ...
                    $Response['status'] = 400;
                    $Response['data'] = [];
                    $Response['message'] = 'An unexpected error occured and your file could not be uploaded. Please, try again later.';
